...
import RedBtn from './basic/RedBtn';
...
const ProfileInfo = () => {
  return (
    <View style={styles.Top}>
      ...
      <Paragraph>
        I post content related to fitness, fun and adventures. Interested to
        watch? Follow me!{' '}
      </Paragraph>
      <View
        style={{
        ...
        <View style={styles.Btn}>
          <H2 style={{color: '#fff'}}>Uses PS5 🟢</H2>
        </View>
        <View style={styles.Btn}>
          <H2 style={{color: '#fff'}}>55 Videos</H2>
        </View>
      </View>

      <View style={styles.Count}>
        <View style={styles.claws}>
          <Heading>3,124 Claws</Heading>
          <H3>And Counting</H3>
        </View>
        <View style={styles.followers}>
          <Heading>3214</Heading>
          <H3>Followers</H3>
        </View>
        <View style={styles.fFlowing}>
          <Heading>564</Heading>
          <H3>Following</H3>
        </View>
      </View>
